...
export const initializeTables = async () => {
  ...
  try {
    ...
    await createBackofficeAppointmentsTable();
    await createCallHistoryRequestsTable();
    await createUnblockMomoRequestsTable();
    await createSerialNumberRequestsTable();
    await createUnblockCallRequestsTable();
    await createOther_RequestsTable();
...
const createBackofficeAppointmentsTable = async () => {
  const tableExists = await checkTableExists('backoffice_appointments');
  
  if (!tableExists) {
    console.log('Creating backoffice_appointments table...');
    await query(`
      CREATE TABLE backoffice_appointments (
        id SERIAL PRIMARY KEY,
        service_request_id INTEGER REFERENCES service_requests(id),
        backoffice_user_id INTEGER REFERENCES users(id),
    ...
    `);
    console.log('backoffice_appointments table created');
  }
};

const createCallHistoryRequestsTable = async () => {
  const tableExists = await checkTableExists('call_history_requests');
  
  if (!tableExists) {
    console.log('Creating call_history_requests table...');
    await query(`
    ...
    `);
    console.log('call_history_requests table created');
  }
};

const createUnblockMomoRequestsTable = async () => {
  const tableExists = await checkTableExists('unblock_momo_requests');
  
  if (!tableExists) {
    console.log('Creating unblock_momo_requests table...');
    await query(`
    ...
    `);
    console.log('unblock_momo_requests table created');
  }
};

const createSerialNumberRequestsTable = async () => {
  const tableExists = await checkTableExists('serial_number_requests');
  
  if (!tableExists) {
    console.log('Creating serial_number_requests table...');
    await query(`
    ...
    `);
    console.log('serial_number_requests table created');
  }
};

const createUnblockCallRequestsTable = async () => {
  const tableExists = await checkTableExists('unblock_call_requests');
  
  if (!tableExists) {
    console.log('Creating unblock_call_requests table...');
    await query(`
    ...
    `);
    console.log('unblock_call_requests table created');
  }
};

const createOther_RequestsTable = async () => {
  const tableExists = await checkTableExists('other_requests');
  
  if (!tableExists) {
    console.log('Creating other_requests table...');
    await query(`
    ...
    `);
    console.log('other_requests table created');
  }
};
