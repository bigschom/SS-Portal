// src/pages/security-services/components/services/StolenPhoneCheck.jsx
...
const StolenPhoneCheck = ({ onBack, serviceType }) => {
  ...
  // Handle input changes for IMEI requests
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white relative">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-semibold">Stolen Phone Check</h1>
          ...
          {!isSuccess ? (
            ...
            >
              <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6 lg:grid-cols-12">
                ...
                {/* Right Panel - IMEI Requests */}
                <div className="lg:col-span-8 space-y-6">
                  {/* IMEI Requests Section */}
                  <motion.div
                    initial={{ opacity: 0, y: 20 }}
                    animate={{ opacity: 1, y: 0 }}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-1 gap-4">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-2 rounded-lg border 
                                        ${formErrors[`imeiRequests.${index}.imei_number`] 
                                          ? 'border-red-500' 
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-6">
                Your stolen phone check request has been submitted with reference number: 
