    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white relative">
      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-semibold">Unblock MoMo Account</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Get assistance with unblocking your MoMo account
            </p>
          </div>
        </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
            ...
            <div className="lg:col-span-8 space-y-6">
              ...
              >
                <h2 className="text-xl font-semibold mb-4 dark:text-white">Request to Unblock MoMo Account</h2>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          <input
                            ...
                            className={`w-full px-4 py-2 rounded-lg border 
                                      ${errors.momoNumbers?.[index]?.number ? 'border-red-500' : 'border-gray-200 dark:border-gray-600'}
                                      bg-white dark:bg-gray-800 dark:text-white
                                      focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent`}
                          />
                        ...
                        <div>
                          <input
                            {...register(`momoNumbers.${index}.date_blocked`)}
                            type="date"
                        ...
                        <div>
                          <select
                            {...register(`momoNumbers.${index}.account_type`)}
                            className="w-full px-4 py-2 rounded-lg border border-gray-200 dark:border-gray-600
                                     bg-white dark:bg-gray-800 dark:text-white
                                     focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent"
                          >
              ...
              >
                ...
                <textarea
                  ...
                  rows={4}
                  placeholder="Please explain why your MoMo account is blocked and provide any additional information that might help with your request"
                  className={`w-full px-4 py-2 rounded-lg border 
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-600 dark:text-blue-400 mt-1">
                      Please ensure that the customer is requesting account unblock 
