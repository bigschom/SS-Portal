...
const CallHistoryRequest = ({ onBack }) => {
  const { user } = useAuth();
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white relative">
      ...
      <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center space-x-3 mb-6">
          ...
          <div>
            <h1 className="text-2xl font-semibold">Call History Request</h1>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-12">
            ...
            {/* Right Panel - Call History Requests */}
            <div className="lg:col-span-8 space-y-6">
              ...
              >
                <h2 className="text-xl font-semibold mb-4 dark:text-white">Call History Requests</h2>
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <div>
                          <input
                            ...
                            className={`w-full px-4 py-2 rounded-lg border 
                                      ${errors.callHistoryRequests?.[index]?.phone_number ? 'border-red-500' : 'border-gray-200 dark:border-gray-600'}
                                      bg-white dark:bg-gray-800 dark:text-white
                                      focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent`}
                          />
                          {errors.callHistoryRequests?.[index]?.phone_number && (
                            <p className="mt-1 text-sm text-red-500 dark:text-red-400">
                              {errors.callHistoryRequests[index].phone_number.message}
                            </p>
                          )}
                        </div>
                        ...
                        <div>
                          <input
                            ...
                            className={`w-full px-4 py-2 rounded-lg border 
                                      ${errors.callHistoryRequests?.[index]?.start_date ? 'border-red-500' : 'border-gray-200 dark:border-gray-600'}
                                      bg-white dark:bg-gray-800 dark:text-white
                                      focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent`}
                          />
                          {errors.callHistoryRequests?.[index]?.start_date && (
                            <p className="mt-1 text-sm text-red-500 dark:text-red-400">
                              {errors.callHistoryRequests[index].start_date.message}
                            </p>
                          )}
                        </div>
                        ...
                        <div>
                          <input
                            ...
                            className={`w-full px-4 py-2 rounded-lg border 
                                      ${errors.callHistoryRequests?.[index]?.end_date ? 'border-red-500' : 'border-gray-200 dark:border-gray-600'}
                                      bg-white dark:bg-gray-800 dark:text-white
                                      focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent`}
                          />
                          {errors.callHistoryRequests?.[index]?.end_date && (
                            <p className="mt-1 text-sm text-red-500 dark:text-red-400">
                              {errors.callHistoryRequests[index].end_date.message}
                            </p>
                          )}
                        </div>
                      </div>
              ...
              >
                ...
                <textarea
                  {...register('details', { required: 'Please explain why you are requesting this call history' })}
                  rows={4}
                  placeholder="Why are you requesting this call history?"
                  className={`w-full px-4 py-2 rounded-lg border 
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-blue-600 dark:text-blue-400 mt-1">
                      Please ensure you are requesting call history for numbers registered under your name. 
                      Call history can only be provided for numbers that belong to the requestor.
                    </p>
                  </div>
                </div>
              </motion.div>
