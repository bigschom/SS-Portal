// src/pages/security-services/components/services/UnblockCallRequest.jsx
...
const UnblockCallRequest = ({ onBack, serviceType }) => {
  ...
  // Handle input changes for phone number requests
  ...
  // Add another phone number request
  const addPhoneNumberRequest = () => {
    setPhoneNumberRequests([
      ...phoneNumberRequests, 
      { number: '', date_blocked: '', reason_blocked: '' }
    ]);
  };

  // Remove a phone number request
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      toast({
        title: "Success",
        description: "Your SIM Card Unblock has been submitted successfully."
      });
      ...
      <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white relative">
        <div className="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-3 mb-6">
            ...
            <div>
              <h1 className="text-2xl font-semibold">SIM Card Unblock</h1>
          ...
          {!isSuccess ? (
            ...
            >
              <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-6 lg:grid-cols-12">
                ...
                {/* Right Panel - Phone Number Requests */}
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-2 rounded-lg border 
                                        ${formErrors[`phoneNumberRequests.${index}.number`] 
                                          ? 'border-red-500' 
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-6">
                Your unblock number request has been submitted with reference number: 
