// src/pages/security-services/components/services/CallHistoryRequest.jsx
...
const CallHistoryRequest = ({ onBack, serviceType }) => {
  ...
  // Handle input changes for call history requests
  ...
  const addCallHistoryRequest = () => {
    setCallHistoryRequests([
      ...callHistoryRequests, 
      { phone_number: '', start_date: '', end_date: '' }
    ]);
  };

  // Remove a call history request
          ...
          {!isSuccess ? (
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-2 rounded-lg border 
                                        ${formErrors[`callHistoryRequests.${index}.phone_number`] 
                                          ? 'border-red-500' 
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-2 rounded-lg border 
                                        ${formErrors[`callHistoryRequests.${index}.start_date`] 
                                          ? 'border-red-500' 
                                          : 'border-gray-200 dark:border-gray-600'}
                                        bg-white dark:bg-gray-800 dark:text-white
                                        focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent`}
                          ...
                          <div>
                            ...
                            <input
                              ...
                              className={`w-full px-4 py-2 rounded-lg border 
                                        ${formErrors[`callHistoryRequests.${index}.end_date`] 
                                          ? 'border-red-500' 
                                          : 'border-gray-200 dark:border-gray-600'}
                                        bg-white dark:bg-gray-800 dark:text-white
                                        focus:ring-2 focus:ring-black dark:focus:ring-white focus:border-transparent`}
            ...
            >
              ...
              <p className="text-gray-500 dark:text-gray-400 mb-6">
                Your call history request has been submitted with reference number: 
